...
Project for parcing, converting and comparing transactions presented in csv, text and bin format. See [specs](docs\format\specs) for the formats specifications and [exmaples](docs\format\examples) for the examples.
